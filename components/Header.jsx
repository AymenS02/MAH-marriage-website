...
const Header = () => {
  ...
  return (
    <>
      {/* Header */}
      <header className="hidden lg:block bg-gradient-to-br from-green-800 to-green-600 text-black py-5 px-5 md:px-12 lg:px-28 backdrop-blur-sm sticky top-0 z-50 border-green-100 shadow-2xl">
